...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    Firebase.initializeApp(
      ...
      apiKey: "AIzaSyDPU9ZoDTDA3nd7wWXloYv1-sA7gBNKmQk",
      appId: "XXX",
      messagingSenderId: "XXX",
      projectId: "XXX",
    )).whenComplete(_resolveDestination);
  }
  ...
  Future<void> _resolveDestination() async {
    ...
    final isFirstLaunch = Hive.box(ConfigBox.key).get(ConfigBox.isFirstLaunch, defaultValue: true) as bool;
